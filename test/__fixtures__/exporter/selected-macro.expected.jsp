...
<!-- macro m_teaser_hero body -->
    ...
    <jsp:include page="/includes/modules/m-teaser.jsp"><jsp:param name="type" value="${ 'hero' }" /><jsp:param name="model" value="${ model }" /><jsp:param name="classes" value="${ '' }" /></jsp:include>
